<?php
/**
 * CAVPP PBCore Additional Descriptive Metadata Element Set plugin
 *
 * Creates a custom additional descriptive element set for 
...
/**
 * The CAVPP PBCore Additional Descriptive Metadata Element Set plugin.
 * @package Omeka\Plugins\CAVPP_PBCoreElementSet
 */
class CAVPP_MD_AdditionalElementSetPlugin extends Omeka_Plugin_AbstractPlugin
{
    private $_elementSetName = 'Additional Descriptive Metadata';
